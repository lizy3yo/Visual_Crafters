...
// ── Auth helper ───────────────────────────────────────────────────────────────
// Cookies are sent automatically via credentials:'include' — no manual token needed
...
function TemplateFormModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-lg rounded-2xl bg-white shadow-xl flex flex-col max-h-[90vh]"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <div
              ...
              className="relative w-full h-40 rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 hover:bg-gray-100 cursor-pointer overflow-hidden transition-colors flex items-center justify-center"
            >
              {form.imagePreview ? (
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent transition"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent transition resize-none"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent transition"
            >
            ...
            <div className="flex gap-2 mt-2">
              <input
                ...
                className="flex-1 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent transition"
              />
              <button
                type="button"
                onClick={addCategory}
                className="px-3 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-600 text-sm font-medium transition-colors"
              >
                Add
              </button>
            </div>
        ...
        <div className="flex justify-end gap-3 px-6 py-4 border-t border-gray-100 shrink-0">
          ...
          <button
            ...
            disabled={saving}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-white bg-sky-500 hover:bg-sky-600 disabled:opacity-60 transition-colors"
          >
...
export default function TemplateManagerPage() {
  ...
  async function handleDelete(t: Template) {
    ...
    try {
      ...
      // SSE will update the list; fallback local update
  ...
  function handleSaved(t: Template) {
    // SSE handles real-time; this is a local fallback
    setTemplates(prev => {
